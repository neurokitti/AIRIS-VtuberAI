...
def main_chat():
    OBS_instance = OBS_engine("204089") 
    chat_instance = chat_engine("microsoft/Phi-3-mini-4k-instruct","hannah",load_in_8bit=True,save_model_dir="phi3",mem_length=7, skip_special_tokens=True,attn_implementation="flash_attention_2",)
    speach_instace = speach_engine()
